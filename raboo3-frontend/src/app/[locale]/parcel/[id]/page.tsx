        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-extrabold text-ink-900 dark:text-white">
              {translateDistrict(parcel.district, locale)} - {translateCity(parcel.city, locale)}
            </h1>
          </div>
          <Link
            ...
            <div className="card p-6 space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <div className="font-semibold text-ink-900 dark:text-white">{translateCity(parcel.city, locale)}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-sm text-slate-600 dark:text-slate-400">{t.parcel.district}</div>
                  <div className="font-semibold text-ink-900 dark:text-white">{translateDistrict(parcel.district, locale)}</div>
                </div>
                <div className="space-y-1">
